...
include("functions/userfunctions.php");
 ...
 if(isset($_GET['product'])){
    ...
    <div class="container">
        <h6 class="text-white">
        <a class="text-white" href="categorys.php">
            home / 
         </a>
            <a class="text-white" href="categorys.php">
            collections / 
 ...
 <div class="bg-light py-4">
        ...
        <div class="conatainer product_data mt-3">
            <div class="row">
                <div class="col-md-4">
                    <div class="shadow">
                    <img src="uploads/<?= $product['image']; ?>" alt="produuct image" class="w-100">
                    </div>
                </div>
                <div class="col-md-8">
  ...
  <button class="input-group-text increment-btn">+</button>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger px-4" name="addtowishlistbtn"><i class="fa fa-heart me-2"></i>Add to wishlist</button>
                        </div>
                    </div>
